			...
			<tr>
				...
				<td>
					<input type="text" name="srform[params][image]"
					       ...
					       id="srform_image" class="regular-text" readonly="true"/>
					<input type="button" name="upload_srform_image" class="button upload_srform_image" value="<?php _e('Upload' , 'solidres') ?>"/>
				</td>
			</tr>
			</tbody>
		</table>
